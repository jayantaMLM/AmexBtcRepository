...
namespace BtcProApp.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public JsonResult GetMyCurrentBinaryIncome()
        {
            ...
            //if (leftamt > rightamt) { currleftamt = leftamt - rightamt; currrightamt = 0; }
            //if (leftamt < rightamt) { currleftamt = 0; currrightamt = rightamt - leftamt; }
            //if (leftamt == rightamt) { currleftamt = 0; currrightamt = 0; }
